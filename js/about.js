function gettingStarted() {
  window.open(
    "docs/start.html",
    "start",
    "status=0, toolbar=0, location=0, menubar=1, directories=0, resizable=1, scrollbars=1, width=400, height=600",
  );
}
...
function outreachReg() {
  window.open(
    "outreach/index.php",
    "outreach",
    "status=0, toolbar=0, location=0, menubar=1, directories=0, resizable=1, scrollbars=1, width=850, height=775",
  );
}
function listReg() {
  window.open(
    "subscribe.php",
    "subscribe",
    "status=0, toolbar=0, location=0, menubar=1, directories=0, resizable=1, scrollbars=1, width=550, height=250",
  );
}
