function helpMe(e) {
        ...
        if (myTarget!="") {
                window.open('help.php?page=' + myTarget, 'help', 'status=0, toolbar=0, location=0, menubar=0, directories=0, resizable=1, scrollbars=1, height=400, width=440, top=100, left=100');
        }
}
...
function productOn(id) {
	...
	document.getElementById('product_'+id).getElementsByTagName('img')[0].src = 'img/question_ffffdd.png';
}
function productOff(id) {
	document.getElementById('product_'+id).style.background = '#aaccff';
	document.getElementById('product_'+id).getElementsByTagName('img')[0].src = 'img/question_aaccff.png';
}
...
$(document).ready(function() {
	...
	if (second_hash<0) { second_hash = locale.length; }
	if (first_hash>=0) {
